...
/// Instruction builder for `InitializePermissionlessPool`.
///
/// ### Accounts:
///
///   0. `[writable]` pool
...
/// `initialize_permissionless_pool` CPI accounts.
...
/// `initialize_permissionless_pool` CPI instruction.
...
/// Instruction builder for `InitializePermissionlessPool` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` pool
