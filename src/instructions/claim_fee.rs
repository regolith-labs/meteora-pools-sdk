...
impl ClaimFee {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = ClaimFeeInstructionData::new().try_to_vec().unwrap();
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct ClaimFeeInstructionArgs {
    pub max_amount: u64,
}
...
impl ClaimFeeBuilder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        ...
        let args = ClaimFeeInstructionArgs {
...
pub struct ClaimFeeCpi<'a, 'b> {
    ...
    pub __args: ClaimFeeInstructionArgs,
}
