...
impl BootstrapLiquidity {
    pub fn instruction(
        &self,
        args: BootstrapLiquidityInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = BootstrapLiquidityInstructionData::new()
            .try_to_vec()
            .unwrap();
...
pub struct BootstrapLiquidityInstructionData {
    discriminator: [u8; 8],
}

impl BootstrapLiquidityInstructionData {
    pub fn new() -> Self {
        Self {
...
impl Default for BootstrapLiquidityInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct BootstrapLiquidityInstructionArgs {
    pub token_a_amount: u64,
    pub token_b_amount: u64,
}

/// Instruction builder for `BootstrapLiquidity`.
///
/// ### Accounts:
///
///   0. `[writable]` pool
...
pub struct BootstrapLiquidityBuilder {
...
impl BootstrapLiquidityBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    /// Pool account (PDA)
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = BootstrapLiquidity {
        ...
        let args = BootstrapLiquidityInstructionArgs {
            token_a_amount: self
                .token_a_amount
                .clone()
...
/// `bootstrap_liquidity` CPI accounts.
pub struct BootstrapLiquidityCpiAccounts<'a, 'b> {
    /// Pool account (PDA)
...
/// `bootstrap_liquidity` CPI instruction.
pub struct BootstrapLiquidityCpi<'a, 'b> {
    ...
    pub __args: BootstrapLiquidityInstructionArgs,
}

impl<'a, 'b> BootstrapLiquidityCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: BootstrapLiquidityCpiAccounts<'a, 'b>,
        args: BootstrapLiquidityInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `BootstrapLiquidity` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` pool
...
///   15. `[]` token_program
#[derive(Clone, Debug)]
pub struct BootstrapLiquidityCpiBuilder<'a, 'b> {
    instruction: Box<BootstrapLiquidityCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> BootstrapLiquidityCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(BootstrapLiquidityCpiBuilderInstruction {
            __program: program,
            pool: None,
            lp_mint: None,
            user_pool_lp: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = BootstrapLiquidityCpi {
...
#[derive(Clone, Debug)]
struct BootstrapLiquidityCpiBuilderInstruction<'a, 'b> {
