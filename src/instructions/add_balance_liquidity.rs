...
impl AddBalanceLiquidity {
    pub fn instruction(
        &self,
        args: AddBalanceLiquidityInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = AddBalanceLiquidityInstructionData::new()
            .try_to_vec()
            .unwrap();
...
pub struct AddBalanceLiquidityInstructionData {
    discriminator: [u8; 8],
}

impl AddBalanceLiquidityInstructionData {
    pub fn new() -> Self {
        Self {
...
impl Default for AddBalanceLiquidityInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct AddBalanceLiquidityInstructionArgs {
    pub pool_token_amount: u64,
    pub maximum_token_a_amount: u64,
    pub maximum_token_b_amount: u64,
}

/// Instruction builder for `AddBalanceLiquidity`.
///
/// ### Accounts:
///
///   0. `[writable]` pool
...
pub struct AddBalanceLiquidityBuilder {
...
impl AddBalanceLiquidityBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    /// Pool account (PDA)
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = AddBalanceLiquidity {
        ...
        let args = AddBalanceLiquidityInstructionArgs {
...
/// `add_balance_liquidity` CPI accounts.
pub struct AddBalanceLiquidityCpiAccounts<'a, 'b> {
    /// Pool account (PDA)
...
/// `add_balance_liquidity` CPI instruction.
pub struct AddBalanceLiquidityCpi<'a, 'b> {
    ...
    pub __args: AddBalanceLiquidityInstructionArgs,
}

impl<'a, 'b> AddBalanceLiquidityCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: AddBalanceLiquidityCpiAccounts<'a, 'b>,
        args: AddBalanceLiquidityInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `AddBalanceLiquidity` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` pool
...
///   15. `[]` token_program
#[derive(Clone, Debug)]
pub struct AddBalanceLiquidityCpiBuilder<'a, 'b> {
    instruction: Box<AddBalanceLiquidityCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> AddBalanceLiquidityCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(AddBalanceLiquidityCpiBuilderInstruction {
            __program: program,
            pool: None,
            lp_mint: None,
            user_pool_lp: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = AddBalanceLiquidityCpi {
...
#[derive(Clone, Debug)]
struct AddBalanceLiquidityCpiBuilderInstruction<'a, 'b> {
