...
impl InitializePermissionedPool {
    pub fn instruction(
        &self,
        args: InitializePermissionedPoolInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = InitializePermissionedPoolInstructionData::new()
            .try_to_vec()
            .unwrap();
...
pub struct InitializePermissionedPoolInstructionData {
    discriminator: [u8; 8],
}

impl InitializePermissionedPoolInstructionData {
    pub fn new() -> Self {
        Self {
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct InitializePermissionedPoolInstructionArgs {
    pub curve_type: CurveType,
}

/// Instruction builder for `InitializePermissionedPool`.
///
/// ### Accounts:
///
...
pub struct InitializePermissionedPoolBuilder {
    ...
    admin_token_a: Option<solana_program::pubkey::Pubkey>,
    admin_token_b: Option<solana_program::pubkey::Pubkey>,
    admin_pool_lp: Option<solana_program::pubkey::Pubkey>,
...
impl InitializePermissionedPoolBuilder {
    ...
    /// Admin pool LP token account. Used to receive LP during first deposit (initialize pool)
    #[inline(always)]
    pub fn admin_pool_lp(&mut self, admin_pool_lp: solana_program::pubkey::Pubkey) -> &mut Self {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = InitializePermissionedPool {
            ...
            admin_token_a: self.admin_token_a.expect("admin_token_a is not set"),
            admin_token_b: self.admin_token_b.expect("admin_token_b is not set"),
            admin_pool_lp: self.admin_pool_lp.expect("admin_pool_lp is not set"),
        ...
        let args = InitializePermissionedPoolInstructionArgs {
...
/// `initialize_permissioned_pool` CPI accounts.
pub struct InitializePermissionedPoolCpiAccounts<'a, 'b> {
    /// Pool account (arbitrary address)
    ...
    /// Admin token account for pool token A mint. Used to bootstrap the pool with initial liquidity.
    pub admin_token_a: &'b solana_program::account_info::AccountInfo<'a>,
    /// Admin token account for pool token B mint. Used to bootstrap the pool with initial liquidity.
    pub admin_token_b: &'b solana_program::account_info::AccountInfo<'a>,
    /// Admin pool LP token account. Used to receive LP during first deposit (initialize pool)
    /// Admin pool LP token account. Used to receive LP during first deposit (initialize pool)
    pub admin_pool_lp: &'b solana_program::account_info::AccountInfo<'a>,
    /// Protocol fee token account for token A. Used to receive trading fee.
...
/// `initialize_permissioned_pool` CPI instruction.
pub struct InitializePermissionedPoolCpi<'a, 'b> {
    ...
    pub __args: InitializePermissionedPoolInstructionArgs,
}

impl<'a, 'b> InitializePermissionedPoolCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: InitializePermissionedPoolCpiAccounts<'a, 'b>,
        args: InitializePermissionedPoolInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
            ...
            admin_token_a: accounts.admin_token_a,
            admin_token_b: accounts.admin_token_b,
            admin_pool_lp: accounts.admin_pool_lp,
    ...
    pub fn invoke_signed_with_remaining_accounts(
        ...
        accounts.push(solana_program::instruction::AccountMeta::new(
            *self.admin_token_a.key,
            false,
        ));
        accounts.push(solana_program::instruction::AccountMeta::new(
            *self.admin_token_b.key,
            false,
        ));
        accounts.push(solana_program::instruction::AccountMeta::new(
            *self.admin_pool_lp.key,
            false,
        ));
        accounts.push(solana_program::instruction::AccountMeta::new(
        ...
        account_infos.push(self.admin_token_a.clone());
        account_infos.push(self.admin_token_b.clone());
        account_infos.push(self.admin_pool_lp.clone());
...
/// Instruction builder for `InitializePermissionedPool` via CPI.
///
/// ### Accounts:
///
///   0. `[writable, signer]` pool
...
///   23. `[]` system_program
#[derive(Clone, Debug)]
pub struct InitializePermissionedPoolCpiBuilder<'a, 'b> {
    instruction: Box<InitializePermissionedPoolCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> InitializePermissionedPoolCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(InitializePermissionedPoolCpiBuilderInstruction {
            __program: program,
            pool: None,
            lp_mint: None,
            token_a_mint: None,
    ...
    pub fn admin_token_a(
        &mut self,
        admin_token_a: &'b solana_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn admin_token_b(
        &mut self,
        admin_token_b: &'b solana_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    /// Admin pool LP token account. Used to receive LP during first deposit (initialize pool)
    #[inline(always)]
    pub fn admin_pool_lp(
        &mut self,
        admin_pool_lp: &'b solana_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn invoke_signed(
        ...
        let instruction = InitializePermissionedPoolCpi {
            ...
            admin_token_a: self
                .instruction
                .admin_token_a
                .expect("admin_token_a is not set"),

            admin_token_b: self
                .instruction
                .admin_token_b
                .expect("admin_token_b is not set"),

            admin_pool_lp: self
                .instruction
                .admin_pool_lp
                .expect("admin_pool_lp is not set"),
...
#[derive(Clone, Debug)]
struct InitializePermissionedPoolCpiBuilderInstruction<'a, 'b> {
    ...
    admin_token_a: Option<&'b solana_program::account_info::AccountInfo<'a>>,
    admin_token_b: Option<&'b solana_program::account_info::AccountInfo<'a>>,
    admin_pool_lp: Option<&'b solana_program::account_info::AccountInfo<'a>>,
